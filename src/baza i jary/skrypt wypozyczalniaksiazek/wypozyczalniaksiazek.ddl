...
INSERT INTO `osoba` (`id_osoba`,`imie`,`nazwisko`,`pesel`,`login`,`haslo`) VALUES(1,'Adam','Nowak',020102030409,'adam','a');
INSERT INTO `osoba` (`id_osoba`,`imie`,`nazwisko`,`pesel`,`login`,`haslo`) VALUES(2,'Bartek','Kowalski',222222222222,'bartek','k');
